...
export const generateDeckPromptTool: ToolDefinition = {
  ...
  handler: async (input: Record<string, unknown>) => {
    ...
    const craftMandate = [
      ...
      "- Match a layout_recipes_reference slide map (pitch / launch / wrap / neon / poster / paper / hud) before freehanding layouts.",
      ...
      "- Match atmosphere to the brief: loud/thin surfaces (coral, raw-grid, sakura, retro-windows, stencil-tablet, retro-zine, daisy-days, block-frame, creative-mode, capsule, scatterbrain, 8-bit-orbit, cobalt-grid, peoples-platform, bold-signal, broadside, genz-bento, bauhaus, neo-grid-bold, bold-poster, creative-voltage, …) for punchy brand energy; neon/vapor/y2k/retro-arcade for cinematic night; aerospace-hud / crt-terminal / blueprint for instrument/tech; paper/editorial themes (claude, soft-editorial, heritage-editorial, emerald-editorial, vintage-editorial, pink-script, ft-editorial, vellum, paper-ink, long-table, broadsheet, biennale-yellow, pastel-dreamy, …) for magazine quiet — PPTX keeps washes, double mastheads, dual insets, hero-gated candy/pills/corner blots, always-on loud frames/offset-shadow strips/multi-layer arcade shadows/Win95 bevels/cobalt grid+hatch/plates/tablets, hard-border cards on genz/acid/bauhaus/neo-grid/bold-poster/raw-grid/voltage/Pulse, neon rim/scanlines/horizon glow/soft aero shadows, mat woodglow+cream rim, HUD reticles/telemetry, and broadside fire rail as native shapes.",
      ...
      "- Poster honesty: coral / peoples-platform / bold-signal / broadside expect hard poster frames + hard-border cards and a bold beat (image-hero, comparison, quote, or punchy stats). mat wants a mid-century beat (quote / image-hero / comparison / punchy stats) with woodglow + cream rim chrome.",
      ...
      "- Call audit_deck before shipping; fix warnings that mention asymmetry, image-hero, tone, emphasis, dual CTA, closing icons, atmosphere, poster, mat, cobalt-grid, HUD/tech, bauhaus, genz-bento, or magazine beats.",
