...
export const generateDeckPromptTool: ToolDefinition = {
  ...
  handler: async (input: Record<string, unknown>) => {
    ...
    const craftMandate = [
      ...
      "- Match atmosphere to the brief: loud/thin surfaces (coral, raw-grid, sakura, retro-windows, …) for punchy brand energy; paper/editorial themes (claude, soft-editorial, heritage-editorial, emerald-editorial, vintage-editorial, pink-script, ft-editorial, vellum, paper-ink, long-table, broadsheet, …) for magazine quiet — PPTX keeps washes, double mastheads, dual insets, and hero-gated candy/pills/corner blots as native shapes.",
