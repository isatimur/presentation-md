...
export const generateDeckPromptTool: ToolDefinition = {
  ...
  handler: async (input: Record<string, unknown>) => {
    ...
    const craftMandate = [
      ...
      "- When theme is unsure: use theme_shortlists_reference (or list_themes include_shortlists/mood/query) — pick a 3-theme shortlist, preview, then lock meta.theme. Default shortlist for vague briefs: core-defaults.",
