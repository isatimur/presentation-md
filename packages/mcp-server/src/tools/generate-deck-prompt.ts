...
export const generateDeckPromptTool: ToolDefinition = {
  ...
  handler: async (input: Record<string, unknown>) => {
    ...
    const craftMandate = [
      ...
      "- Match atmosphere to the brief: loud/thin surfaces (coral, raw-grid, sakura, retro-windows, stencil-tablet, retro-zine, daisy-days, …) for punchy brand energy; paper/editorial themes (claude, soft-editorial, heritage-editorial, emerald-editorial, vintage-editorial, pink-script, ft-editorial, vellum, paper-ink, long-table, broadsheet, …) for magazine quiet — PPTX keeps washes, double mastheads, dual insets, hero-gated candy/pills/corner blots, and always-on loud frames/plates/tablets as native shapes.",
      ...
      "- Loud honesty: stencil-tablet / retro-zine / daisy-days expect hard frames + earth/riso/pastel plates on every slide (not hero-only) — don't invent custom-html stickers for atmosphere.",
