...
export const generateDeckPromptTool: ToolDefinition = {
  ...
  handler: async (input: Record<string, unknown>) => {
    ...
    const craftMandate = [
      ...
      "- Match atmosphere to the brief: loud/thin surfaces (coral, raw-grid, sakura, retro-windows, stencil-tablet, retro-zine, daisy-days, block-frame, creative-mode, capsule, scatterbrain, 8-bit-orbit, cobalt-grid, peoples-platform, bold-signal, broadside, …) for punchy brand energy; neon/vapor/y2k/retro-arcade for cinematic night; paper/editorial themes (claude, soft-editorial, heritage-editorial, emerald-editorial, vintage-editorial, pink-script, ft-editorial, vellum, paper-ink, long-table, broadsheet, biennale-yellow, pastel-dreamy, …) for magazine quiet — PPTX keeps washes, double mastheads, dual insets, hero-gated candy/pills/corner blots, always-on loud frames/offset-shadow strips/multi-layer arcade shadows/Win95 bevels/cobalt grid+hatch/plates/tablets, neon rim/scanlines/horizon glow/soft aero shadows, mat woodglow+cream rim, and broadside fire rail as native shapes.",
      ...
      "- Call audit_deck before shipping; fix warnings that mention asymmetry, image-hero, tone, emphasis, dual CTA, closing icons, atmosphere, poster, mat, cobalt-grid, or magazine beats.",
