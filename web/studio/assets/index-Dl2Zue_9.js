const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CjAm5r0n.js","assets/jszip.min-CzDb6sHe.js","assets/_commonjsHelpers-Cpj98o6Y.js","assets/index-TcX-Oxg-.js","assets/index-j3PGmdS7.js"])))=>i.map(i=>d[i]);
...
Respond with ONLY the JSON object — no prose, no markdown fences.`}function V8(e){const t=e.match(/```(?:json)?\s*([\s\S]*?)```/i),n=((t==null?void 0:t[1])??e).trim(),r=n.indexOf("{"),a=n.lastIndexOf("}");return r===-1||a===-1||a<r?n:n.slice(r,a+1)}async function Q8(e){const{apiKey:t,model:n,brief:r,theme:a,signal:o}=e;if(!r.trim())throw new Error("Describe your deck first.");if(!t.trim())throw new Error("Enter your Anthropic API key.");const{default:i}=await es(async()=>{const{default:h}=await import("./index-j3PGmdS7.js");return{default:h}},__vite__mapDeps([4,2])),d=(await new i({apiKey:t.trim(),dangerouslyAllowBrowser:!0}).messages.create({model:n,max_tokens:8e3,system:f1,messages:[{role:"user",content:`${g1(r,a)}
