const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-rT3NUMG4.js","assets/_commonjsHelpers-Cpj98o6Y.js","assets/index-CV7pyCLL.js"])))=>i.map(i=>d[i]);
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Em=R,$m=Symbol.for("react.element"),Nm=Symbol.for("react.fragment"),Tm=Object.prototype.hasOwnProperty,Pm=Em.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,zm={key:!0,ref:!0,__self:!0,__source:!0};function ks(e,n,t){var r,o={},a=null,l=null;t!==void 0&&(a=""+t),n.key!==void 0&&(a=""+n.key),n.ref!==void 0&&(l=n.ref);for(r in n)Tm.call(n,r)&&!zm.hasOwnProperty(r)&&(o[r]=n[r]);if(e&&e.defaultProps)for(r in n=e.defaultProps,n)o[r]===void 0&&(o[r]=n[r]);return{$$typeof:$m,type:e,key:a,ref:l,props:o,_owner:Pm.current}}fo.Fragment=Nm;fo.jsx=ks;fo.jsxs=ks;fs.exports=fo;var d=fs.exports,Ss={exports:{}},ke={},_s={exports:{}},Cs={};/**
 * @license React
...
`,r1=`<section class="slide comparison-slide">
  {{#eyebrow}}<span class="eyebrow">{{eyebrow}}</span>{{/eyebrow}}
...
`,l1=`<section class="slide image-hero-slide">
...
`,i1=`<section class="slide quote-slide">
  <p class="quote">{{quote}}</p>
  {{#by}}<p class="quote-by">— {{by}}</p>{{/by}}
</section>
`,s1=`<section class="slide section-slide">
  {{#number}}<div class="section-number">{{number}}</div>{{/number}}
  <h2>{{heading}}</h2>
  {{#lead}}<p class="lead">{{lead}}</p>{{/lead}}
</section>
`,u1=`<section class="slide">
  {{#eyebrow}}<span class="eyebrow">{{eyebrow}}</span>{{/eyebrow}}
  {{#heading}}<h2>{{heading}}</h2>{{/heading}}
  <div class="stats">
    {{#stats}}
...
`,d1=`<section class="slide title-slide">
  {{#eyebrow}}<span class="eyebrow">{{eyebrow}}</span>{{/eyebrow}}
  <h1>{{heading}}</h1>
  {{#lead}}<p class="lead">{{lead}}</p>{{/lead}}
</section>
`,f1=`<section class="slide">
  <div class="cols">
    <div>
      {{#eyebrow}}<span class="eyebrow">{{eyebrow}}</span>{{/eyebrow}}
      <h2>{{heading}}</h2>
...
`,T1="warm-paper",P1="clean-light",z1="soft-bento",M1="bauhaus-blocks",O1="vapor-horizon",F1="hygge-soft",I1="blueprint-grid",L1="glass-mist",R1="newsprint-masthead",D1={claude:T1,"default-tech":"neon-glow",corporate:P1,playful:z1,"luxury-minimalist":"quiet-luxe","retro-arcade":"scanline-neon","editorial-serif":"editorial-rule","brutalist-mono":"brutalist-grid","pastel-dreamy":"pastel-cloud","aurora-glass":"aurora-glass","ft-editorial":"broadsheet-rule","genz-bento":"hard-bento","crt-terminal":"crt-phosphor","swiss-typographic":"swiss-grid","candy-pop":"candy-blob","aerospace-hud":"hud-grid","brutalist-acid":"acid-block",bauhaus:M1,"y2k-aero":"aero-bubble","risograph-zine":"riso-print","neon-noir":"neon-rain",vaporwave:O1,"botanical-luxe":"botanical-leaf","heritage-editorial":"heritage-wash","fintech-clean":"fintech-soft","developer-dark":"dev-terminal","data-editorial":"data-rule",scandinavian:F1,"art-deco":"deco-fan","kinetic-wrapped":"wrapped-block",blueprint:I1,glassmorphism:L1,broadsheet:R1},A1=`<!doctype html>
<html lang="en">
<head>
<meta charset="utf-8" />
...
`;function B1(e){return D1[e]??"gradient"}const U1=Object.assign({"../../../shared/layouts/closing.html":t1,"../../../shared/layouts/comparison.html":r1,"../../../shared/layouts/data-table.html":o1,"../../../shared/layouts/feature-grid.html":a1,"../../../shared/layouts/image-hero.html":l1,"../../../shared/layouts/quote.html":i1,"../../../shared/layouts/section.html":s1,"../../../shared/layouts/stat-row.html":u1,"../../../shared/layouts/timeline.html":c1,"../../../shared/layouts/title.html":d1,"../../../shared/layouts/two-column.html":f1}),nm=new Map;for(const[e,n]of Object.entries(U1)){const t=e.split("/").pop().replace(/\.html$/,"");nm.set(t,n)}function W1(e){return e.length===0?"":`https://fonts.googleapis.com/css2?family=${e.join("&family=")}&display=swap`}const H1=new Set(["http","https","mailto","tel"]);function tm(e){let n="";for(const t of e){const r=t.charCodeAt(0);r>31&&r!==127&&(n+=t)}return n}function rm(e){var n,t;return(t=(n=e.match(/^([a-zA-Z][a-zA-Z0-9+.-]*):/))==null?void 0:n[1])==null?void 0:t.toLowerCase()}function V1(e){if(typeof e!="string")return;const n=tm(e).trim(),t=rm(n);return t&&!H1.has(t)?"#":n}function Q1(e){if(typeof e!="string")return;const n=tm(e).trim();if(/^data:image\//i.test(n))return n;const t=rm(n);return t&&t!=="http"&&t!=="https"?"":n}function G1(e){var t;const n={...e};return e.layout==="data-table"&&Array.isArray(e.rows)&&(n.rows=e.rows.map(r=>({cells:r}))),e.layout==="feature-grid"&&(typeof e.columns=="number"?n.columns=e.columns:e.columns||(n.columns=3)),((t=e.cta)==null?void 0:t.href)!==void 0&&(n.cta={...e.cta,href:V1(e.cta.href)}),e.image!==void 0&&(n.image=Q1(e.image)),n}const K1='<footer class="pmd-attribution">Made with <a href="https://presentation-md.vercel.app/?ref=studio" target="_blank" rel="noopener">presentation-md</a></footer>',Y1=`
...
@media print { .pmd-attribution { opacity: 0.5; } }`;function X1(e){return`<script type="application/json" id="pmd-deck">${JSON.stringify(e).replace(/</g,"\\u003c")}<\/script>`}function om(e,n){var u,f,h;const t={bg:n.palette.bg,bg2:n.palette.bg2,text:n.palette.text,muted:n.palette.muted,accent:n.palette.accent,accent2:n.palette.accent2,cardBg:n.palette.cardBg,border:n.palette.border,radius:n.geometry.radius,slideW:n.geometry.slideWidth,headingFont:n.typography.headingFont,bodyFont:n.typography.bodyFont,headingWeight:String(n.typography.headingWeight)},r=ye.render(N1,t),o=W1(n.typography.googleFonts),a=B1(n.name);let l=o?`@import url('${o}');
...
- Only emit fields defined above. Do not invent new layouts or fields.`;function sm(e,n){return`Create a deck for the following brief. Set meta.theme to "${n}".

Brief:
${e.trim()}`}function px(e,n){return`${im}

${sm(e,n)}

Respond with ONLY the JSON object — no prose, no markdown fences.`}function hx(e){const n=e.match(/```(?:json)?\s*([\s\S]*?)```/i),t=((n==null?void 0:n[1])??e).trim(),r=t.indexOf("{"),o=t.lastIndexOf("}");return r===-1||o===-1||o<r?t:t.slice(r,o+1)}async function gx(e){const{apiKey:n,model:t,brief:r,theme:o,signal:a}=e;if(!r.trim())throw new Error("Describe your deck first.");if(!n.trim())throw new Error("Enter your Anthropic API key.");const{default:l}=await am(async()=>{const{default:h}=await import("./index-CV7pyCLL.js");return{default:h}},__vite__mapDeps([2,1])),u=(await new l({apiKey:n.trim(),dangerouslyAllowBrowser:!0}).messages.create({model:t,max_tokens:8e3,system:im,messages:[{role:"user",content:`${sm(r,o)}

Respond with ONLY the JSON object — no prose, no markdown fences.`}]},{signal:a})).content.map(h=>h.type==="text"?h.text:"").join("");if(!u.trim())throw new Error("The model returned an empty response. Try again.");let f;try{f=Yl(hx(u))}catch(h){throw new Error(`Couldn't parse the generated deck: ${h.message}`)}return f.meta={...f.meta,theme:o},f}const jr="pmd-studio-anthropic-key",mx=["Q3 all-hands: momentum, key metrics, roadmap, and what's next.","Seed pitch for an AI-native analytics tool — problem, product, traction, ask.","Launch deck for a developer CLI: what it is, how it works, why it's fast."];function yx({currentTheme:e,onGenerate:n,onClose:t}){const[r,o]=R.useState(""),[a,l]=R.useState(e),[i,s]=R.useState(ds[0].id),[u,f]=R.useState(()=>localStorage.getItem(jr)??""),[h,m]=R.useState(()=>!!localStorage.getItem(jr)),[v,S]=R.useState(!1),[w,$]=R.useState(""),[p,c]=R.useState(!1),g=em(),x=async()=>{S(!0),$("Generating your deck…");try{h?localStorage.setItem(jr,u.trim()):localStorage.removeItem(jr);const b=await gx({apiKey:u,model:i,brief:r,theme:a});n(b),t()}catch(b){$(b.message)}finally{S(!1)}},y=async()=>{try{await navigator.clipboard.writeText(px(r,a)),c(!0),setTimeout(()=>c(!1),1800)}catch{$("Couldn't copy — select the prompt manually.")}};return d.jsx("div",{className:"modal-overlay",onClick:t,children:d.jsxs("div",{className:"modal",onClick:b=>b.stopPropagation(),children:[d.jsxs("header",{className:"modal-head",children:[d.jsxs("div",{children:[d.jsx("strong",{children:"Generate a deck"}),d.jsx("span",{className:"muted small",children:"Describe it — get an editable deck in seconds."})]}),d.jsx("button",{className:"btn btn-sm",onClick:t,"aria-label":"Close",children:"✕"})]}),d.jsxs("div",{className:"modal-body",children:[d.jsx("label",{className:"field-label",children:"What's the deck about?"}),d.jsx("textarea",{className:"text-input brief-input",value:r,placeholder:"e.g. Q3 all-hands covering revenue, product wins, and the roadmap for next quarter.",rows:4,onChange:b=>o(b.target.value)}),d.jsx("div",{className:"chip-row",children:mx.map(b=>d.jsx("button",{className:"chip",onClick:()=>o(b),title:"Use this brief",children:b.split(/[:—]/)[0].trim()},b))}),d.jsxs("div",{className:"field-grid",children:[d.jsxs("label",{className:"inline-field",children:[d.jsx("span",{className:"muted small",children:"Theme"}),d.jsx("select",{className:"text-input",value:a,onChange:b=>l(b.target.value),children:g.map(b=>d.jsx("option",{value:b,children:b},b))})]}),d.jsxs("label",{className:"inline-field",children:[d.jsx("span",{className:"muted small",children:"Model"}),d.jsx("select",{className:"text-input",value:i,onChange:b=>s(b.target.value),children:ds.map(b=>d.jsx("option",{value:b.id,children:b.label},b.id))})]})]}),d.jsxs("div",{className:"gen-panel",children:[d.jsx("label",{className:"field-label",children:"Your Anthropic API key"}),d.jsx("input",{className:"text-input",type:"password",value:u,placeholder:"sk-ant-…",autoComplete:"off",onChange:b=>f(b.target.value)}),d.jsxs("label",{className:"checkbox-field",children:[d.jsx("input",{type:"checkbox",checked:h,onChange:b=>m(b.target.checked)}),d.jsx("span",{className:"muted small",children:"Remember on this device (stored only in your browser)"})]}),d.jsxs("p",{className:"muted small privacy-note",children:["Your key stays in this browser. Requests go straight to Anthropic — nothing is sent to our servers. Get a key at ",d.jsx("a",{href:"https://console.anthropic.com/settings/keys",target:"_blank",rel:"noreferrer",children:"console.anthropic.com"}),"."]}),d.jsx("button",{className:"btn btn-primary btn-block",disabled:v,onClick:x,children:v?"Generating…":"Generate deck"})]}),d.jsx("div",{className:"gen-divider",children:d.jsx("span",{children:"or hand it to your agent"})}),d.jsxs("div",{className:"gen-panel",children:[d.jsx("p",{className:"muted small",children:"No key? Copy a ready-made prompt and paste it into Claude Code, Cursor, or any agent with the presentation skill installed — then open the resulting deck here."}),d.jsx("button",{className:"btn btn-block",onClick:y,disabled:!r.trim(),children:p?"Copied ✓":"Copy prompt for your agent"})]}),w&&d.jsx("p",{className:"status muted small gen-status",children:w})]})]})})}const um="pmd-studio-deck-v1";function vx(){try{const e=localStorage.getItem(um);if(e){const n=JSON.parse(e);if((n==null?void 0:n.type)==="deck"&&Array.isArray(n.slides)&&n.slides.length)return n}}catch{}return Cc}function xx(){var v;const[e,n]=R.useState(vx),[t,r]=R.useState(0),[o,a]=R.useState(!1),[l,i]=R.useState(!1);R.useEffect(()=>{try{localStorage.setItem(um,JSON.stringify(e))}catch{}},[e]);const s=R.useMemo(()=>{var S;try{return om(e,Vl(((S=e.meta)==null?void 0:S.theme)??"default-tech"))}catch(w){return`<pre style="color:#d9695a;font-family:monospace;padding:24px">${String(w)}</pre>`}},[e]),u=(S,w)=>{n({...e,slides:S}),w!==void 0&&r(w)},f=S=>{n({...e,slides:e.slides.map((w,$)=>$===t?S:w)})},h=()=>{n(Cc),r(0)},m=e.slides[Math.min(t,e.slides.length-1)];return d.jsxs("div",{className:"app",children:[d.jsx(ax,{deck:e,onChange:n,onLoadExample:h,onPresent:()=>a(!0),onGenerate:()=>i(!0)}),d.jsxs("div",{className:"workspace",children:[d.jsx("aside",{className:"panel panel-left",children:d.jsx(lx,{slides:e.slides,selected:t,onSelect:r,onChange:u})}),d.jsx("main",{className:"panel panel-center",children:d.jsx(cx,{html:s})}),d.jsx("aside",{className:"panel panel-right",children:m?d.jsx(sx,{slide:m,onChange:f}):d.jsx("p",{className:"muted",children:"No slide selected."})})]}),o&&d.jsx(fx,{html:s,slideCount:e.slides.length,onClose:()=>a(!1)}),l&&d.jsx(yx,{currentTheme:((v=e.meta)==null?void 0:v.theme)??"claude",onGenerate:S=>{n(S),r(0)},onClose:()=>i(!1)})]})}const cm=document.getElementById("root");if(!cm)throw new Error("Missing #root element");_c(cm).render(d.jsx(R.StrictMode,{children:d.jsx(xx,{})}));export{am as _};
