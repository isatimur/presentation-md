const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-BkIPKd2Q.js","assets/_commonjsHelpers-Cpj98o6Y.js","assets/index-BUMbV7Jc.js"])))=>i.map(i=>d[i]);
...
`,I8=`<section class="slide data-table-slide" data-layout="data-table">
  {{#eyebrow}}<span class="eyebrow">{{eyebrow}}</span>{{/eyebrow}}
  {{#heading}}<h2>{{heading}}</h2>{{/heading}}
  <table>
    <thead>
...
`;function P_(e){return j_[e]??"gradient"}const M_=Object.assign({"../../../shared/layouts/closing.html":z8,"../../../shared/layouts/code.html":A8,"../../../shared/layouts/comparison.html":D8,"../../../shared/layouts/data-table.html":I8,"../../../shared/layouts/feature-grid.html":O8,"../../../shared/layouts/image-hero.html":B8,"../../../shared/layouts/quote.html":L8,"../../../shared/layouts/section.html":R8,"../../../shared/layouts/stat-row.html":W8,"../../../shared/layouts/timeline.html":G8,"../../../shared/layouts/title.html":U8,"../../../shared/layouts/two-column.html":H8}),tk=new Map;for(const[e,n]of Object.entries(M_)){const t=e.split("/").pop().replace(/\.html$/,"");tk.set(t,n)}function N_(e){return e.length===0?"":`https://fonts.googleapis.com/css2?family=${e.join("&family=")}&display=swap`}const z_=new Set(["http","https","mailto","tel"]);function rk(e){let n="";for(const t of e){const r=t.charCodeAt(0);r>31&&r!==127&&(n+=t)}return n}function ak(e){var n,t;return(t=(n=e.match(/^([a-zA-Z][a-zA-Z0-9+.-]*):/))==null?void 0:n[1])==null?void 0:t.toLowerCase()}function A_(e){if(typeof e!="string")return;const n=rk(e).trim(),t=ak(n);return t&&!z_.has(t)?"#":n}function D_(e){if(typeof e!="string")return;const n=rk(e).trim();if(/^data:image\//i.test(n))return n;const t=ak(n);return t&&t!=="http"&&t!=="https"?"":n}function I_(e){var t;const n={...e};return e.layout==="data-table"&&Array.isArray(e.rows)&&(n.rows=e.rows.map(r=>({cells:r}))),e.layout==="feature-grid"&&(e.columns==="bento"?n.columns="bento":typeof e.columns=="number"?n.columns=e.columns:e.columns||(n.columns=3)),((t=e.cta)==null?void 0:t.href)!==void 0&&(n.cta={...e.cta,href:A_(e.cta.href)}),e.image!==void 0&&(n.image=D_(e.image)),n}const O_='<footer class="pmd-attribution">Made with <a href="https://presentation-md.vercel.app/?ref=studio" target="_blank" rel="noopener">presentation-md</a></footer>',B_=`
