...
| **Discovery** | Studio **pick-3 compare** with Title/Bento/Compare crops (Generate + theme tray) + Example live trio + mood/popular browse + CLI `--preview-compare` + `preview_themes` **auto-layouts** on pick-3 | Live style gallery (strong) |
