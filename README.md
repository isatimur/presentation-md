...
| **Discovery** | Studio **pick-3 compare** with Title/Bento/Compare crops + mood/popular browse + CLI `--preview-compare` + `preview_themes` layouts bake | Live style gallery (strong) |
